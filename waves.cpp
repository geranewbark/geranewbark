...
#include <windows.h>
#include <iomanip>
//ДЛЯ ТОГО ЧТОБЫ ОНО БЕСКОНЕЧНО ШЛОО НУЖНО ИСПОЛЬЗОВАТЬ БУФЕР КОНСОЛИ, 
//ИНАЧЕ ЦВЕТ КОНСОЛИ МЕНЯЕТСЯ, КОГДА БЕГУНОК ДОХОДИТ ДО НИЗА 
...
{   
 ...
 //ХОЧУ СДЕЛАТЬ, ЧТОБЫ НЕ ПЕРЕНОС СТРОКИ БЫЛ, А ЧТОБЫ ПРОБЕЛЫ ВЫСТАВЛЯЛИСЬ,
 //ТАКИМ ОБРАЗОМ ОНИ БУДУТ В ЦВЕТУ   
